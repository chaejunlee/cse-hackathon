...
const leaderSchema = z.object({
  ...
  github: z
    .string()
    .min(1, { message: "github 아이디를 입력해주세요" }),
});
...
const Apply = () => {
  ...
  const [numOfTeammates, setNumOfTeammates] =
    useState<number>(1);
  ...
  const onSubmitInvalid: SubmitErrorHandler<formProps> = (
    errors
  ) => {
